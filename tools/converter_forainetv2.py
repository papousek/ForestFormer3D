...
def create_info_file(data_path, pkl_prefix="forainetv2", save_path=None, workers=4):
    ...
    assert pkl_prefix in ["forainetv2"], f"unsupported dataset {pkl_prefix}"
    ...
    val_filename = os.path.join(save_path, f"{pkl_prefix}_oneformer3d_infos_val.pkl")
    test_filename = os.path.join(save_path, f"{pkl_prefix}_oneformer3d_infos_test.pkl")
